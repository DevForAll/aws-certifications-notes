...
"¿A cuántos clientes activos aproximadamente atiende AWS en la actualidad?
Usted administra su infraestructura de AWS a través de un navegador web. ¿Qué permite esto?", "¿Cuál es el papel de los centros de datos en el contexto de AWS?", "AWS tiene una plataforma de nube con más de ________ servicios. (en este caso indica que agregue cual es el estimado o el valor fijo)", "¿Qué significa 'Aprovisionamiento'?"